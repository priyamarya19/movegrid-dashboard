  ...
  return (
    <DashboardLayout allowedRoles={["investor"]}>
      <div className="space-y-6">
        <div>
          <h1 className="text-primary text-2xl font-bold">Support</h1>
          <p className="text-muted text-sm mt-1">Send us a message and we&apos;ll get back to you</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          {/* Info panel */}
          <div className="lg:col-span-2 bg-gradient-to-br from-on-dark to-surface border border-accent-success/20 rounded-2xl p-6 flex flex-col">
            <div className="w-11 h-11 rounded-xl bg-accent-success/15 flex items-center justify-center text-accent-success mb-4">
            ...
            <h2 className="text-primary font-semibold text-lg">We&apos;re here to help</h2>
            ...
            <div className="mt-6 space-y-4">
              {points.map((p) => (
                <div key={p.title} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-secondary text-sm font-medium">{p.title}</p>
          ...
          {/* Form */}
          <div className="lg:col-span-3 bg-surface border border-default rounded-2xl p-6 lg:p-8">
            <SupportForm />
          </div>
        </div>
      </div>
